...
const Categories = () => {
  return (
    <div className='w-full dark:bg-[#ecd0cb] items-center py-10 px-10'>
        <div className='md:max-w-[1480px] m-auto max-w-[600px]  px-4 md:px-0'>
                <h1 className='md:leading-[72px] text-3xl font-bold'>Most <span className='text-[#DB5A42]'>Popular Categories</span></h1>
