...
const FeedbackCard = () => {
  return (
    <div className='bg-[#ffb5a7] p-8 rounded-3xl shadow-xl my-8 mx-2'>
      <div className='flex justify-between'>
        <div className='flex gap-4'>
                <img src={avatar} />
                <div>
                    <h1>Guadalupe Garcia</h1>
                </div>
      ...
      <div className='py-8'>
        <h3 className='text-lg'>¡Mi familia y yo tuvimos una experiencia increíble usando la página de viajes y transporte en Yucatán! Desde el momento en que llegamos al aeropuerto de Mérida, todo fue perfecto. El servicio de traslado al hotel fue puntual y cómodo, y el conductor fue muy amable y conocedor de la zona.
